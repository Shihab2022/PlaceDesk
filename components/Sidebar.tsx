...
interface SidebarProps {
  pois: BusinessPOI[];
  selectedPoi: BusinessPOI | null;
  onSelectPoi: (poi: BusinessPOI) => void;
}

export default function Sidebar({ pois, selectedPoi, onSelectPoi }: SidebarProps) {
  return (
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between gap-2">
                <h3 className="font-semibold text-slate-900 text-sm">{poi.name}</h3>
